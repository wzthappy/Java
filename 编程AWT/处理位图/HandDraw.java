...
public class HandDraw {
    ...
    public void init() {
        ...
        drawArea.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseReleased(MouseEvent e) {  //鼠标键抬起时被调用

                boolean popupTrigger = e.isPopupTrigger();  //右击
                if (popupTrigger) {
        ...
        drawArea.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (preX > 0 && preY > 0) {
                    ...
                    //划线条   需要两组坐标，分别代表线条的起点和终点   e.getX(),e.getY()可以获取坐标()
